...
function _thrive_save_post_options( $post_data ) {
	...
	add_post_meta( $post_ID, '_thrive_meta_post_focus_area_top', $thrive_meta_post_focus_area_top, true ) or
	update_post_meta( $post_ID, '_thrive_meta_post_focus_area_top', $thrive_meta_post_focus_area_top );

	add_post_meta( $post_ID, '_thrive_meta_post_focus_area_bottom', $thrive_meta_post_focus_area_bottom, true ) or
	update_post_meta( $post_ID, '_thrive_meta_post_focus_area_bottom', $thrive_meta_post_focus_area_bottom );
