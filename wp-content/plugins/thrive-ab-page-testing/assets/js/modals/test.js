var optins_settings = require( '../views/goals/optins-settings' ),
	goal_page_settings = require( '../views/goals/monetary-settings' ),
...
module.exports = TVE_Dash.views.ModalSteps.extend( {
	...
	afterRender: function () {
		...
		this.$( '.thrive-ab-goal[data-goal="optins"]' ).toggleClass( 'thrive-ab-disabled tvd-tooltipped', has_forms ).attr( 'data-tooltip', 'This goal type is only available if there is a lead generation form on each of the page variations' ).attr( 'data-position', 'top' );
	},
	...
	render_goal_settings: function () {
		...
		switch ( this.model.get( 'type' ) ) {
			case 'monetary':
				this.goal_settings_view = new goal_page_settings( _options );
				break;
			case 'visits':
