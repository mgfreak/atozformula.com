...
//		add_action( 'template_redirect', array( __CLASS__, 'template_redirect' ), - 1 );
	...
	protected static function get_goals( $goal = '' ) {
		...
		$goals = array(
			'monetary' => array(
				'icon'  => 'monetary-2',
				'label' => __( 'Goal one', Thrive_AB::T ),
				'name'  => __( 'Revenue', Thrive_AB::T ),
			),
			'visits'   => array(
				'icon'  => 'visit_gp',
				'label' => __( 'Goal two', Thrive_AB::T ),
				'name'  => __( 'Visit goal page', Thrive_AB::T ),
			),
			'optins'   => array(
				'icon'  => 'subs',
				'label' => __( 'Goal three', Thrive_AB::T ),
				'name'  => __( 'Subscriptions', Thrive_AB::T ),
			),
		);
