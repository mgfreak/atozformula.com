...
class Thrive_AB_Meta_Box_Completed_Tests_Table extends WP_List_Table {
	...
	public function no_items() {
		echo __( 'There are no Thrive A/B Completed Tests for this page', Thrive_AB::T );
	}
	...
	public function get_columns() {
		$columns = array(
			'title'          => __( 'Completed Test', Thrive_AB::T ),
			'notes'          => __( 'Description', Thrive_AB::T ),
			'date_started'   => __( 'Start Date', Thrive_AB::T ),
			'date_completed' => __( 'End Date', Thrive_AB::T ),
			'view_test'      => '',
			'delete_test'    => '',
		);
	...
	private function table_data() {
		...
		foreach ( $this->_page_tests as $test ) {
			...
			$preview_link = '<a href="' . $this->_page->get_test_link( $test->id ) . '">' . tcb_icon( 'external-link', true, 'sidebar', 'thrive-ab-edit-post-icons' ) . ' ' . __( 'View Test', Thrive_AB::T ) . '</a>';
			$delete_link  = '<a href="' . $delete_href . '">' . tcb_icon( 'trash-o', true, 'sidebar', 'thrive-ab-edit-post-icons' ) . ' ' . __( 'Delete', Thrive_AB::T ) . '</a>';
