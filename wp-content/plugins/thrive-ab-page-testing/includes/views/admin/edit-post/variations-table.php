...
<?php if ( $this->_pagination_args['total_items'] > 0 ) : ?>
	<div class="thrv-ab-action-button-wrapper">
		<?php if ( count( $this->_page_tests ) > 0 ) : ?>
			...
			<a class="thrv-ab-action-button" href="<?php echo $view_test_link; ?>"><?php echo __( 'View Test Details', Thrive_AB::T ); ?></a>
		<?php else : ?>
			<a class="thrv-ab-action-button" href="<?php echo $start_test_link . '#dashboard/start-test'; ?>"><?php echo __( 'Set Up & Start A/B Test', Thrive_AB::T ); ?></a>
		<?php endif; ?>
	</div>
<?php endif; ?>
