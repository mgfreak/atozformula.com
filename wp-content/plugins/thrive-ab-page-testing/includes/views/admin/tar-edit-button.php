...
<!--		--><?php //echo __( 'Edit with Thrive Architect', Thrive_AB::T ) ?>
<!--	</div>-->
<!--</a>-->
<!-- TOP-143 <p style="display: inline;">--><?php //echo sprintf( __( 'Page editing is disabled while the A/B test is running. Click <a href="%s">here</a> to manage/end the test and enable editing again.', Thrive_AB::T ), $view_test_link ); ?><!--</p>-->
