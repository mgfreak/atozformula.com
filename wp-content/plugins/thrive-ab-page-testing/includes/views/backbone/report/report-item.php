...
<td colspan="2" class="thrv-ab-variation-control">[ <?php echo __( 'This is the control', Thrive_AB::T ); ?> ]</td>
<# }else{ #>
<td>
...
<td>
	...
	<a class="tvd-tooltipped tvd-right click" href="javascript:void(0);" data-fn="stop_variation" data-tooltip="<?php echo __( 'Stop this variation', Thrive_AB::T ); ?>" data-position="top">
