...
<div class="thrive-ab-adv-settings">
	<div class="tvd-row">
		<div class="tvd-col tvd-s12 thrive-ab-no-padding">
			<?php echo __( 'Select one or more pages, from your website, on which the user will land. You can also create a new page and edit later.', Thrive_AB::T ) ?>
		</div>
	</div>
		...
		<div class="tvd-col tvd-s12">
			<div class="tvd-card tvd-small tvd-card-new thrive-ab-add-new-goal tvd-valign-wrapper">
				<div class="tvd-card-content tvd-valign tvd-center-align">
					...
					<h4>
						<?php echo __( 'Add new goal page', Thrive_AB::T ) ?>
					</h4>
				</div>
			</div>
		</div>
