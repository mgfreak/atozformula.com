...
<div class="row">
	<div class="col col-xs-12">
		<p><?php echo __( "You are about to save changes to a page in a running test. Note that major design changes will invalidate the data gathered in this test so far. For this reason, we recommend that you reset the test data to zero (the test will continue running).", Thrive_AB::T ) ?></p>
	</div>
</div>
<div class="tcb-gray">
	<div class="row">
