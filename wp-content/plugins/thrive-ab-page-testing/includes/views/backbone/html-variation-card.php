		...
		<div class="thrive-ab-card-head tvd-row">
			<div class="tvd-col tvd-s9">
				<div class="thrive-ab-title-content">
					...
					<a href="javascript:void(0)" class="<#= item.get('is_control') ? '' : 'tvd-icon-pencil' #> click tvd-tooltipped" data-tooltip="<?php echo __( 'Edit variation name', Thrive_AB::T ); ?>" data-position="top" data-fn="edit_title"></a>
				</div>
				<div class="thrive-ab-title-editor"></div>
			</div>
			<div class="thrive-ab-card-options tvd-col tvd-s3 thrive-ab-card-actions">
				<a class="tvd-icon-copy click tvd-tooltipped" data-tooltip="<?php echo __( 'Duplicate this variation', Thrive_AB::T ); ?>" data-position="top" data-fn="duplicate"></a>
				<a class="tvd-icon-trash-o tab-archive click tvd-tooltipped" data-tooltip="<?php echo __( 'Archive variation', Thrive_AB::T ); ?>" data-position="top" data-fn="archive" style="<#= item.get('is_control') ? 'display:none;' : '' #>"></a>
				<a class="tvd-icon-trash-o click tvd-tooltipped" data-tooltip="<?php echo __( 'Permanently delete variation', Thrive_AB::T ); ?>" data-position="top" data-fn="delete" style="<#= item.get('is_control') ? 'display:none;' : '' #>"></a>
			</div>
		</div>
		<div class="thrive-ab-card-thumb" style="background-image: url('<#= item.get('thumb_link') #>')">
			<div>
				<a href="<#= item.get('edit_link') #>" class=""><?php echo __( 'Edit Variation', Thrive_AB::T ) ?></a>
			</div>
		</div>
		<div class="thrive-ab-card-footer tvd-row">
			<div class="tvd-col tvd-s2">
				<label for="thrive-ab-card-traffic-input"><?php echo __( 'Traffic', Thrive_AB::T ) ?></label>
			</div>
