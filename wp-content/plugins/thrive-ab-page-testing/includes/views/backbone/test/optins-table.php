...
<div class="thrive-ab-test-header">
	<div class="tvd-row">
		<div class="tvd-col tvd-s3"><?php echo __( 'Variation Name', Thrive_AB::T ) ?></div>
		...
		<div class="tvd-col tvd-s1"><?php echo __( 'Subscriptions', Thrive_AB::T ) ?></div>
		<div class="tvd-col tvd-s1"><?php echo __( 'Subscription Rate', Thrive_AB::T ) ?></div>
