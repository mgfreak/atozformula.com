...
<div class="tvd-row tvd-collapse">
	<div class="tvd-col tvd-s12">
		<span class="tab-label"><?php echo __( 'Enable Automatic Winner Settings', Thrive_AB::T ) ?></span>
...
<div id="auto-win-settings">
	<span><?php echo __( 'Here you can set the conditions by which a form will be considered the winner.', Thrive_AB::T ) ?></span>
	<div class="tvd-row tvd-gray">
		<div class="tvd-col tvd-s4">
			<div class="tvd-input-field">
				...
				<label for="auto_win_min_conversions"><?php echo __( 'Minimum conversions', Thrive_AB::T ) ?></label>
			</div>
		</div>
		<div class="tvd-col tvd-s4">
			<div class="tvd-input-field">
				...
				<label for="auto_win_min_duration" class=""><?php echo __( 'Minimum duration (days)', Thrive_AB::T ) ?></label>
			</div>
		</div>
		<div class="tvd-col tvd-s4">
			<div class="tvd-input-field">
				...
				<label for="auto_win_chance_original" class=""><?php echo __( 'Chance to beat original (%)', Thrive_AB::T ) ?></label>
			</div>
		</div>
	</div>
</div>
