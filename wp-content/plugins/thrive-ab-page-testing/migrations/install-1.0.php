...
$create_table_test = "CREATE TABLE IF NOT EXISTS {$installer->get_table_name( 'tests' )} (
...
$create_test_items = "CREATE TABLE IF NOT EXISTS {$installer->get_table_name( 'test_items' )} (
	`id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
	`page_id` BIGINT(20) UNSIGNED NOT NULL,
...
$create_event_log = "CREATE TABLE IF NOT EXISTS {$installer->get_table_name( 'event_log' )} (
	`id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
	`page_id` BIGINT(20) UNSIGNED NOT NULL,
	`variation_id` BIGINT(20) UNSIGNED NOT NULL,
	`test_id` BIGINT(20) UNSIGNED NOT NULL,
...
$installer->add( $create_table_test );
$installer->add( $create_test_items );
$installer->add( $create_event_log );
