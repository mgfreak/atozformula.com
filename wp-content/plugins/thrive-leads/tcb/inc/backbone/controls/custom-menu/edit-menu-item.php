...
<div class="tcb-link-search">
	<input type="text" class="tcb-menu-item-text" class="change target" data-fn="changed" value="" autocomplete="off">
</div>
<div id="a-link-main" class="tcb-link-search">
	<input type="text" class="tcb-link-suggest ui-autocomplete-input" placeholder="Paste URL or type to search" autocomplete="off">
	<div class="url-preview"></div>
		<ul class="ui-autocomplete ui-front ui-menu ui-widget ui-widget-content tcb-suggest tcb-fixed-200 tcb-full-width" id="ui-id-5" tabindex="0" ></ul>
</div>
