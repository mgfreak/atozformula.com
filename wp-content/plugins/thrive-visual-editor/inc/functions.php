...
function tve_clean_wp_editor_content( $content ) {
	...
	if ( ! empty( $is_visual_composer ) && is_plugin_active( 'js_composer/js_composer.php' ) ) {
		return $content;
	}
...
function tve_render_custom_menu( $attributes ) {
	$custom_menu_items     = array( 'Home' => array(), 'About us' => array( 'Team', 'Company' ), 'Our products' => array( 'Prices' ), 'Contact' => array() );
